                    ...
                    {(["create", "join"] as const).map((value) => (
                        <button
                            ...
                            className={`flex-1 py-2.5 text-sm font-bold transition-all ${
                                tab === value ? "bg-blue-500 text-white" : "bg-white/5 text-blue-300 hover:bg-white/10"
                            }`}
                        >
